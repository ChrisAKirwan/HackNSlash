...
void AHackNSlashPlayerController::SetupInputComponent()
{
	...
	InputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AHackNSlashPlayerController::MoveToTouchLocation);
	InputComponent->BindTouch(EInputEvent::IE_Repeat, this, &AHackNSlashPlayerController::MoveToTouchLocation);

	InputComponent->BindAction("ResetVR", IE_Pressed, this, &AHackNSlashPlayerController::OnResetVR);
}

void AHackNSlashPlayerController::OnResetVR()
{
...
void AHackNSlashPlayerController::MoveToMouseCursor()
{
	...
	{
		if (AHackNSlashCharacter* MyPawn = Cast<AHackNSlashCharacter>(GetPawn()))
		{
...
void AHackNSlashPlayerController::MoveToTouchLocation(const ETouchIndex::Type FingerIndex, const FVector Location)
{
